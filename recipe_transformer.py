...
def call_api(recipe_url = None):
	...
	print('10. Scale ingredients')
	print('11. Use metric units')
	switch = find_input()
	...
	if switch == 10:
		scaling_factor = int(input("Please provide a number: "))
		ingredients, steps = transforming.transform_ingredients(mappings,ingredients,steps,'scale_recipe', scaling_factor)
		transformation_name = 'Scaled recipe'
	if switch == 11:
		ingredients, steps = transforming.transform_ingredients(mappings,ingredients,steps,'use_metric')
		transformation_name = 'Metric unts'
